...
class IndirimEkle extends StatefulWidget {
  const IndirimEkle({Key? key}) : super(key: key);

  @override
  State<IndirimEkle> createState() => _IndirimEkleState();
}

class _IndirimEkleState extends State<IndirimEkle> {
  ...
  TextEditingController indirimController = TextEditingController();
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    indirimServices.addIndirim(adController.text, yerController.text, saatController.text, indirimController.text);
                    //temizle
                    adController.clear();
                    saatController.clear();
                    yerController.clear();
                    indirimController.clear();
                    //
